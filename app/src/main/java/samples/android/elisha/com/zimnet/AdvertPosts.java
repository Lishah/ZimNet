...
public class AdvertPosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advert_posts);
        ...
        mAuthStateListener =new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseAuth.getCurrentUser() == null){
                    Intent loginIntent = new Intent(AdvertPosts.this, LoginActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Adverts,MainActivity.AdvertViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Adverts, MainActivity.AdvertViewHolder>(

                Adverts.class,
                R.layout.adverts_row,
                MainActivity.AdvertViewHolder.class,
                mAdvertsDatabseReference

        ) {
            @Override
            protected void populateViewHolder(MainActivity.AdvertViewHolder viewHolder, Adverts model, int position) {
...
//               viewHolder.setDescription(model.getAdvert_description());
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent advertIntent = new Intent(AdvertPosts.this, AdvertDetails.class);
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (!dataSnapshot.hasChild(user_uid)) {
                        ...
                        Intent setupIntent = new Intent(AdvertPosts.this, AccountSetUp.class);
...
//            Picasso.with(ctx).load(image).into(adverts_Image);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId()== R.id.action_add){
            ...
            startActivity(new Intent(AdvertPosts.this, PostActivity.class));
        }
